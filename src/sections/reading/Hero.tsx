...
import { ChevronDown, BookOpen, Network, Lightbulb } from 'lucide-react';
...
const Hero = () => {
  ...
  const scrollToContent = () => {
    const nextSection = document.getElementById('knowledge-graph');
    if (nextSection) {
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="hud-element mb-8 flex justify-center">
          <div className="relative">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#00d4ff]/20 to-[#39ff14]/10 border border-[#00d4ff]/40 flex items-center justify-center">
              <Network className="w-10 h-10 text-[#00d4ff]" />
            </div>
        ...
        <p className="text-[#4a5568] max-w-xl mx-auto mb-12">
          A curated collection of books, papers, and resources that shaped my understanding 
          of machine learning, statistics, and software engineering.
        </p>

        {/* Stats Row */}
        <div className="hud-element flex flex-wrap justify-center gap-8 md:gap-12">
          {[
            { value: '47', label: 'Books Read', icon: BookOpen },
            { value: '156', label: 'Papers', icon: Network },
            { value: '23', label: 'Topics', icon: Lightbulb },
          ].map((stat, i) => {
